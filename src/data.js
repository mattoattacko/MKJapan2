...
export const foodData = {
  "Shibuya/Harajuku Area": [
    ...
    { name: "Mini Pig Cafe", note: "Mini pig cafe in Shibuya", time: "10 mins" },
    { name: "HARRY HARAJUKU terrace", note: "Might be otters here", time: "10 mins" },
  ],
  "Shinjuku Area": [
    ...
    { name: "BAR GOLD FINGER", note: "Was on Queer Eye TV", time: "5 mins" },
  ],
  "Ikebukuro Area": [
  ...
  "Central Tokyo": [
    ...
    { name: "Tokyo Banana World", note: "Tokyo Banana Shop in Tokyo Station", time: "5 mins to Ginza Station" },
    { name: "DAWN | Avatar Robot Cafe ver.β", note: "Robot Cafe", time: "5 mins to Nihonbashi Station" },
    { name: "Pokémon Café Near Nihonbashi", note: "Need reservations", time: "5 mins to Nihonbashi Station" },
    { name: "Sanrio Garden Cafe", note: "Brand new Sanrio collab cafe! Emirichu", time: "5 mins to Ueno Station" },
  ],
  "Yokohama Area": [
...
export const shoppingData = {
  ...
  "Central Tokyo": [
    ...
    { name: "Nihonbashi", note: "Shopping Area", time: "@Nihonbashi Station" },
    ...
    { name: "BOOKOFF SUPER BAZAAR SEIYU", note: "Omori Store Book Off", time: "5 mins to Omori Station" },
  ],
  "Yokohama Area": [
